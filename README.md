...
| Role | Tag | Notes |
| --- | --- | --- |
| **SemVer (latest)** | [`v0.1.13`](https://github.com/kazuru-chidumbwe/dns-stack-diff-harness/releases/tag/v0.1.13) | Serial-hop TTL relationship on two pairings (Kind NodeLocal→CoreDNS via a dedicated Service, and compose Unbound→CoreDNS-forwarder), 20–300s, each point vs remaining-TTL prediction |
...
- **Serial-hop cache-staleness (load-bearing):** cite **`v0.1.13`** · Kind packs `artifacts/layer2-kind-serial-cache-20260915T185233Z/` (and 185304Z / 185538Z / 185749Z) and compose packs `artifacts/layer2-compose-serial-cache-20260915T192609Z/` (and 192636Z / 192742Z / 192949Z) — NodeLocal forwards to a dedicated CoreDNS Service, not to `10.96.0.10`; Unbound compose chain is the second pairing; lag tracks remaining TTL across 20–300s
